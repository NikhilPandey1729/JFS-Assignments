...
public class collectionQ1 {
	...
	public static void main(String[] args) {
		Details D1 = new Details("Nikhil", "ni@gmail.com", "Male");
		Details D2 = new Details("Yash", "ya@gmail.com", "Male");
		Details D3 = new Details("Abhi", "ab@gmail.com", "Male");
		Details D4 = new Details("Sonu", "so@gmail.com", "Male");
		Details D5 = new Details("saswat", "sa@gmail.com", "Male");
		
		phoneNumber P1 = new phoneNumber(0123456789);
		phoneNumber P2 = new phoneNumber(4567789454);
		phoneNumber P3 = new phoneNumber(4598798498);
		phoneNumber P4 = new phoneNumber(8798491984);
		phoneNumber P5 = new phoneNumber(9841959849);
